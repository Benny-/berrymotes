 ...
 * return res.badRequest(err, 'some/specific/badRequest/view');
 *
 * First argument can be a string or a Error object.
 *
 */

module.exports = function badRequest(err, options) {
  ...
  else return res.view('400', locals, function (err, html) {
